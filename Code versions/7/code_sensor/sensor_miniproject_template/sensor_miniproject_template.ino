...
static void handleCommand(const TPacket *cmd) {
    ...
    switch (cmd->command) {
        case COMMAND_ESTOP:
            ...
            break;
        case COMMAND_ARM: // Ensure COMMAND_ARM is defined in your packets.h
            {
                // params[0] stores the joint letter (B, S, E, G)
                // params[1] stores the target angle
                handleArmCommand((char)cmd->params[0], (int)cmd->params[1]);
